...
/**
 * Gap/CFS Feature Page: No calendar integration.
 * Slug: no-calendar-integration
 * Backend: /api/gap-no-calendar-integration
 */
export default function NoCalendarIntegrationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-calendar-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No calendar integration.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No calendar integration.</p>
