...
/**
 * Gap/CFS Feature Page: Supply chain prediction
 * Slug: supply-chain-prediction
 * Backend: /api/cf-supply-chain-prediction
 */
export default function SupplyChainPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-supply-chain-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Supply chain prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Forecast supply needs; coordinate pre-positioning of critical supplies.</p>
