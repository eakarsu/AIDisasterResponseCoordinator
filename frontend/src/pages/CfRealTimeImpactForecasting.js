...
/**
 * Gap/CFS Feature Page: Real-time impact forecasting
 * Slug: real-time-impact-forecasting
 * Backend: /api/cf-real-time-impact-forecasting
 */
export default function RealTimeImpactForecastingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-real-time-impact-forecasting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Real-time impact forecasting</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Combine weather, terrain, population data; predict disaster impact before it occurs.</p>
