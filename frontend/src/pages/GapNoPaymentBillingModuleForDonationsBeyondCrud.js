...
/**
 * Gap/CFS Feature Page: No payment/billing module (for donations beyond CRUD).
 * Slug: no-payment-billing-module-for-donations-beyond-crud
 * Backend: /api/gap-no-payment-billing-module-for-donations-beyond-crud
 */
export default function NoPaymentBillingModuleForDonationsBeyondCrudPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-billing-module-for-donations-beyond-crud', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No payment/billing module (for donations beyond CRUD).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No payment/billing module (for donations beyond CRUD).</p>
