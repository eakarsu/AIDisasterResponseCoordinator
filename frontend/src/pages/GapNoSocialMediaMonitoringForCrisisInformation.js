...
/**
 * Gap/CFS Feature Page: No social-media monitoring for crisis information.
 * Slug: no-social-media-monitoring-for-crisis-information
 * Backend: /api/gap-no-social-media-monitoring-for-crisis-information
 */
export default function NoSocialMediaMonitoringForCrisisInformationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-social-media-monitoring-for-crisis-information', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No social-media monitoring for crisis information.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No social-media monitoring for crisis information.</p>
