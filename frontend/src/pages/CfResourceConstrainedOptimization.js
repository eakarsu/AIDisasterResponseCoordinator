...
/**
 * Gap/CFS Feature Page: Resource-constrained optimization
 * Slug: resource-constrained-optimization
 * Backend: /api/cf-resource-constrained-optimization
 */
export default function ResourceConstrainedOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-resource-constrained-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Resource-constrained optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Given limited resources, recommend optimal allocation to minimize casualties/damage.</p>
