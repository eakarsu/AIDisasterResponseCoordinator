...
/**
 * Gap/CFS Feature Page: Limited mobile app for first responders.
 * Slug: limited-mobile-app-for-first-responders
 * Backend: /api/gap-limited-mobile-app-for-first-responders
 */
export default function LimitedMobileAppForFirstRespondersPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-mobile-app-for-first-responders', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited mobile app for first responders.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited mobile app for first responders.</p>
