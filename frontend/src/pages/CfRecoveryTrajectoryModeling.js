...
/**
 * Gap/CFS Feature Page: Recovery trajectory modeling
 * Slug: recovery-trajectory-modeling
 * Backend: /api/cf-recovery-trajectory-modeling
 */
export default function RecoveryTrajectoryModelingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-recovery-trajectory-modeling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Recovery trajectory modeling</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict recovery timeline; recommend interventions to accelerate recovery.</p>
